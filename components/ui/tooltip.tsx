  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 max-w-xs origin-(--radix-tooltip-content-transform-origin) rounded-md bg-stone-900 px-2.5 py-1.5 text-xs font-medium text-stone-50 shadow-md",
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="-my-px fill-stone-900" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
